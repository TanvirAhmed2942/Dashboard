...
export default function BarCharts() {
  return (
    <div className="w-full h-[300px] bg-white p-4 rounded-md shadow-md">
      <h2 className="text-lg font-medium mb-2">Site Visitors</h2>
      <ResponsiveContainer width="100%" height="100%">
        <BarChart data={data} margin={{ top: 5, right: 30, left: 20, bottom: 5 }} width={10} height={80}>
          <CartesianGrid strokeDasharray="none" strokeWidth={0.2} vertical={false}/>
          <XAxis dataKey="name" />
          <YAxis hide={false} />
          <Tooltip />
          <Legend />
          {/* <Bar dataKey="uv" fill="#82ca9d" /> */}8884d8
